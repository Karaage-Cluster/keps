...
Implementation
--------------
Before we can start, we need to ensure that there are Debian python3 packages
of all the relevant libraries.

For each package, we need to:

*  All required libraries have also been updated.
*  Ensure code is compatible with Python 2.7, Python 3.2 and Python 3.4.
...
*  python3-django-south. South is obsolete. Django 1.7 has a new migration
   system that is incompatible with South. All migrations will have to be
